...
import { Fixture, cleanupTemporaryWorkDirectories, createTemporaryWorkDirectory, getFixturePath } from './fixtures/fixture-util';
...
describe("Test Merx flow |", () => {
    ...
    const config: Config = {
        merx: {
            input: getFixturePath(Fixture.merx),
    ...
    it("can process XML, and output correctly", async () => {
        ...
        assertObjectProperties(
            ...
            {article_nr: "04755", description1: "Snapsglas 4,5 cl Granity", price: 21.00, minimum_sell: 48, netprice: 0, stock_quantity: 576}
        )
        assertObjectProperties(
        ...
        assertObjectProperties(
            ...
            {article_nr: "04755", description1: "Snapsglas 4,5 cl Granity (48-pack)", price: 1311, minimum_sell: 48, netprice: 0, stock_quantity: 12}
        )
        assertObjectProperties(
            outputXml.merx_products.product[1], 
            {article_nr: "2095560", description1: "Contigo Byron, Gunmetal (96-pack)", price: 27000, minimum_sell: 96, netprice: 1, stock_quantity: 0}
        )
        assertObjectProperties(
            outputXml.merx_products.product[2], 
            {article_nr: "2095663", description1: "Contigo Byron, Matte Black (96-pack)", price: 27000, minimum_sell: 96, netprice: 1, stock_quantity: 0}
        )
        assertObjectProperties(
            outputXml.merx_products.product[3], 
            {article_nr: "1005R", description1: "Bordsgaffel 180 mm Gammal Svensk", price: 402, minimum_sell: 1, netprice: 0, stock_quantity: 15}
        )
        assertObjectProperties(
            outputXml.merx_products.product[4], 
            {article_nr: "1007R", description1: "Dessertkniv 175 mm Gammal Svensk", price: 504, minimum_sell: 1, netprice: 0, stock_quantity: 56}
        )
        assertObjectProperties(
            outputXml.merx_products.product[5], 
            {article_nr: "09994", description1: "Skål Ø 26 cm, stapelbar (6-pack)", price: 97, minimum_sell: 6, netprice: 0, stock_quantity: 2}
        )
    })
})